...
const job_data = {
    ...
    carrer_info: <> A 100% distributed team, you can work from anywhere. We are proud of a  <br/>culture of 
communication, collaboration, trust and kindness.
    </>,
    job_info: [
        {
            id:1, 
            category: "Senior Backend Engineer (Integrations)",
            job_time: "Full-time",
            job_location: "Remote",
        },
        {
        ...
        {
            id:4, 
            category: "Junior Backend Developer",
            job_time: "Full-time",
            job_location: "Remote",
        },
      //   {
