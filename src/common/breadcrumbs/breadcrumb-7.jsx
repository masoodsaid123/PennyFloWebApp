                  ...
                  <div className="row justify-content-center">
                     <div className="col-xl-10">
                        <div className="breadcrumb__content z-index-3 text-center">
                           <h3 ref={animeRef} className="breadcrumb__title tp-char-animation text-black anime_text">Pennyflo Features</h3>
                           <div className="breadcrumb__text wow tpfadeUp" data-wow-duration=".9s" data-wow-delay=".6s">
                              <p>We’re on a mission to build a design centric AI powered tool to automate all the financial 
                              operations  <br /> and to work in sync with the team.</p>
                           </div>
                        </div>
                     </div>
                  </div>
