...
const platform_content ={
    ...
    title: "Our Values",
    description: <>Pennyflo is always improving to make it easier for businesses to handle their finances.</>,
...
const platform_data = [
    {
        ...
        count: "01",
        title: "Excellence",
        sub_title: "Excellence",
        des: <>With more than 12 years of expertise, we exactly know the pain of 
businesses in managing their cash.</>
    ...
    },
    {
        ...
        des: <>We are committed to make the cash management tasks simple and 
hassle free.</>,
    ...
    },
    {
        ...
        sub_title: "Responsibility",
        des: <>We are committed to help the entrepreneurs and visionaries to build 
    ...
    },
    {
        ...
        title: "Teamwork",
        sub_title: "Teamwork",
        des: <>We are always willing to go an extra mile for our customers to get the the 
