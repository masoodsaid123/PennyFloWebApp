                  ...
                  <div className="row align-content-start">
                     <div className="col-xl-7 col-lg-7">
                        <div className="career-details-wrapper">
                           ...
                           <h4 className="career-details-title" style={{ lineHeight: '45px'}}>{career?.title || 'No Title Available'}</h4>
                           </div>
                     ...
                     <div className="col-xxl-12">
                        ...
                        <div className="col-xxl-12">
                           <div className="career-details-social-box mb-20">
                              <Link className="facebook" href="https://www.linkedin.com/company/pennyflo/"><i className="fab fa-linkedin-in"></i></Link>
                              <Link className="twitter" href="https://twitter.com/PennyFlo_"><i className="fab fa-twitter"></i></Link>
                              {/* <Link className="instagram p-relative" href="#">
                                 <div className="insta-bg"></div>
                                 <i className="fab fa-instagram"></i>
                              </Link> */}
                              <Link className="linkedin" href="https://www.youtube.com/@PennyFlo"><i className="fab fa-youtube"></i></Link>
                           </div>
                           <div className="career-details-bottom-text text-center">
                              <Link href="#">Employee at Pennyflo?</Link>
                           </div>
                        </div>
                     </div>
                  </div>
