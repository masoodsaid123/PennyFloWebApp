                           ...
                           <div className="row">
                              <div className="col-xl-4 col-lg-4 col-md-4">
                                 <div className="team-details-img-box text-center">
                                    <div className="team-details-img">
                                       <Image src={member.img} alt="theme-pure" width={150} height={150}/>
                                    </div>
                              ...
                              <div className="col-xl-8 col-lg-8 col-md-8">
                                 <div className="team-details-info-box">
                                    <h3 className="team-details-client-title">{member.name}</h3>
                                    <div className="team-details-contact-box d-flex align-items-center">
                                       <div className="team-details-social-info">
                                          {/* <Link href="#"><i className="fab fa-facebook-f"></i></Link> */}
                                          <a href={member.socials.twitter} target='_blank'><i className="fab fa-twitter"></i></a>
                                          <a href={member.socials.linkedin} target='_blank'><i className="fab fa-linkedin-in"></i></a>
                                    ...
                                    <div className="team-details-skill">
                                       <h5>{member.skill_title}</h5>
                                       {member.details_skill.map((item, i)  => <span key={i}>{item}</span>)} 
                                    </div>
                                 </div>
                              </div>
                           </div> 
                     ...
                     <div className="col-xl-8 col-lg-10">
                        <div className="team-details-text-wrapper pt-80">
                           <div className="team-details-text">
                              <h4 className="team-details-title">{member.about_title}</h4>
                              <p>{member.about_info_1}</p>
                           </div>
                           {/* <div className="team-details-feature-list">
                              <ul>
                              {member.feature_list.map((item, i) => <li key={i}>{item}</li>)} 
                              </ul>
                              <p>{member.about_info_2}</p>
                           </div> */}
                        </div>
                     </div>
                  </div>
