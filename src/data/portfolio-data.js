...
import thumb_img_1 from "../../public/assets/img/project/Cashflow monitoring.svg";
import thumb_img_2 from "../../public/assets/img/project/Overdue payments.svg";
import thumb_img_3 from "../../public/assets/img/project/Dashboard.svg";
import thumb_img_4 from "../../public/assets/img/project/Forecast 1.svg";
import thumb_img_5 from "../../public/assets/img/project/Export.svg";
...
const portfolio_data = [    
    {
        ...
        des: <>Monitor your cash-flow from all your current accounts and know your cash 
    ...
    }, 
    {
        ...
        des: <>Multi-player model with individual permissions and tracking & approval workflows.</>,
        delay: ".5s",
    ...
    },
    {
        ...
        des: <>Generate custom reports and share it with anyone at ease.</>,
        delay: ".5s",
        category: "Design Work",
        filter_id: ["all", "Design Work", "Branding", "Development", "Illusutration", "App Design" ],
    }, 
    {
        ...
        title: <>Scenario Analysis & Dynamic Cash-flow Forecasts</>,
        des: <>Visualize the cash-flow for near future scenarios.</>,
        delay: ".5s",
    ...
    
    {
        ...
        title: <>AP/AR Automation with Auto-reconciliation</>,
        des: <>Process 1 or 1000 payments in a couple of clicks, from local to international without errors.</>,
        delay: ".5s",
        category: "Branding",
        filter_id: ["all", "Design Work", "Branding", "Development", "Illusutration", "App Design" ],
    }, 
